            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      <h2>${requestScope.student.name} &nbsp;&nbsp;&nbsp; <button id="updateBtn" onclick="updateStudent('${requestScope.student.id}')" >정보수정</button></h2>
                    ...
                    <div class="col-md-4">  
                      ...
                      <div class="clearfix"></div><div class="bot-border"></div>
                      <div class="col-sm-5 col-xs-6 tital " >ID:</div><div class="col-sm-7 col-xs-6 ">${requestScope.student.id}</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
                    </div>
                </div>
              </div>
